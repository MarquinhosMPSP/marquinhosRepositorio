const arpenp = async (browser, nrprocesso) => {
  ...
  try {
    ...
    await Promise.all([
      page.click(
        "#main > div.container > div:nth-child(2) > div:nth-child(2) > div > a"
      ),
    ...
    let data = await page.evaluate(() => {
      let cartregistro = document.querySelector(
        "#principal > div > form > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(2)"
      ).innerText;

      let cns = document.querySelector(
        "#principal > div > form > table:nth-child(3) > tbody > tr:nth-child(2) > td:nth-child(2) > b"
      ).innerText;
      let uf = document.querySelector(
        "#principal > div > form > table:nth-child(3) > tbody > tr:nth-child(3) > td:nth-child(2) > b"
      ).innerText;
      let nome1 = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(2) > td:nth-child(2)"
      ).innerText;
      let nvnome1 = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(3) > td:nth-child(2)"
      ).innerText;
      let nome2 = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(4) > td:nth-child(2)"
      ).innerText;
      let nvnome2 = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(5) > td:nth-child(2)"
      ).innerText;
      let dataCasamento = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(6) > td:nth-child(2)"
      ).innerText;
      let matricula = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(8) > td:nth-child(2) > b"
      ).innerText;
      let dataEntrada = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(9) > td:nth-child(2) > b"
      ).innerText;
      let dataRegistro = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(10) > td:nth-child(2)"
      ).innerText;
      let acervo = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(11) > td:nth-child(2)"
      ).innerText;
      let nlivro = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(12) > td:nth-child(2)"
      ).innerText;
      let nfolha = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(13) > td:nth-child(2)"
      ).innerText;
      let nregistro = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(14) > td:nth-child(2)"
      ).innerText;
      let tipolivro = document.querySelector(
        "#principal > div > form > table:nth-child(15) > tbody > tr:nth-child(15) > td:nth-child(2) > b"
      ).innerText;
