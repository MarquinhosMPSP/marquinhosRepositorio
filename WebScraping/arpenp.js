const arpenp = async (browser) => {
    ...
    let data = await page.evaluate(() =>{
        let cartregistro = document.querySelector('#principal > div > form > table:nth-child(3) > tbody > tr:nth-child(1) > td:nth-child(2) > b').innerText;
        ...
        let nome1 = document.querySelector('<td>Antonio TORRES Coutinho</td>').innerText;
